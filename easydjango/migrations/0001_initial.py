# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-25 20:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, default=None, max_length=255, null=True, upload_to='notification_icons', verbose_name='Icon')),
                ...
                ('auto_hide_seconds', models.IntegerField(blank=True, default=0, verbose_name='Automatically hide after (in seconds, 0 means no auto-hide)')),
                ('display_mode', models.CharField(choices=[('notification', 'HTML notification'), ('modal', 'Blocking (modal) window'), ('system', 'System notification'), ('banner', 'Screen-wide banner')], default='notification', max_length=20, verbose_name='Display mode')),
                ...
                ('repeat_count', models.IntegerField(blank=True, db_index=True, default=1, help_text='Display count (0 means always display the notification)', verbose_name='Repeat count')),
                ('author', models.ManyToManyField(blank=True, db_index=True, related_name='notification_author', to=settings.AUTH_USER_MODEL, verbose_name='Users that should read this message')),
